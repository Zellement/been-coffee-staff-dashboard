...
const IndexPage = ({ data }) => {
  ...
  return (
    <>
      ...
      <a href="https://us18.campaign-archive.com/?u=b7e751c2857c9a81fb5f4c502&id=9e95713b41" target="_blank" rel="noopener noreferrer" className="fixed bottom-0 left-0 z-20 p-2 text-white bg-tuscany-500">
