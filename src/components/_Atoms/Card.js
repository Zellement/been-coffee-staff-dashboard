  ...
  return (
    ...
    >
      <div className="flex justify-between w-full gap-4">
        { sticky ? <span className="absolute top-0 right-0 flex p-1.5 overflow-hidden -translate-y-4 rounded-full bg-butterscotch translate-x-4"><RiPushpin2Fill /></span> : null }
        <h2>{title}</h2>
        {date ? (
